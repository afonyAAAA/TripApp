...
fun CityScreen(navHostController: NavHostController){
    ...
    val activeCity: MutableState<City> = remember { mutableStateOf(SELECTED_CITY) }
...
@Composable
private fun ImageAttraction(activeCity: MutableState<City>){
    Image(
...
@Composable
private fun DescriptionText(activeCity: MutableState<City>){
    Text(
...
@Composable
private fun NameAttraction(activeCity: MutableState<City>){
    Card(
        modifier = Modifier
            .height(50.dp),
